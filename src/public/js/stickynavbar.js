...
if(window.location.pathname=='/' || window.location.pathname.includes('winners') || window.location.pathname.includes('events') || window.location.pathname.includes('register') )
{
